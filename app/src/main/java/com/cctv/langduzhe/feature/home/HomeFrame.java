 ...
 * 说明：首页视频fragment
 */
public class HomeFrame extends BaseFragment implements MediaPackageView {
    ...
    */
    private void initFrame() {
        ...
        vpHomeVideo.setAdapter(new ContentPagerAdapter(mFragmentManager, seasonList));
    ...
    */
    ...
    private RadioButton getTabItem(String title) {
        RadioButton tabView = (RadioButton) LayoutInflater.from(getActivity()).inflate(R.layout.item_home_tab, null, false);
