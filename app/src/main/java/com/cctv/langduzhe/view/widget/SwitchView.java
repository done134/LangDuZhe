 ...
 * 业务名:自定义switchView
 * 功能说明:高仿IOS滑动开关！
 * 自定义过程、使用说明及API地址【CSDN】：http://blog.csdn.net/bfbx5173/article/details/45191147#comments
 * github地址：https://github.com/iielse/SwitchButton
 */
public class SwitchView extends View {
    private final int DEFAULT_COLOR_PRIMARY = 0xFF0CC295;
    private final int DEFAULT_COLOR_PRIMARY_DARK = 0xFF0CC295;
