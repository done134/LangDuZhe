...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    /**
    * @author 尹振东
    * create at 2018/1/25 上午12:30
    * 方法说明：控件跟着屏幕旋转
    */
    private void rotationAnimation(int from, final int to) {
        ...
        progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                tvRecordTime.setRotation(currentAngle);
                mSwitchCamera.setRotation(currentAngle);
                mFlashLamp.setRotation(currentAngle);
                if(to!=0) {
                    setTip("");
                }else{
                    setTip(getContext().getString(R.string.record_video_tip));
                }
            }
        });
